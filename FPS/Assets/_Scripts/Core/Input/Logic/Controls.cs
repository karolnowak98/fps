        ...
        public struct GameplayActions
        {
            ...
            public void SetCallbacks(IGameplayActions instance)
            {
                if (m_Wrapper.m_GameplayActionsCallbackInterface != null)
                {
                    ...
                    @Btn1.started -= m_Wrapper.m_GameplayActionsCallbackInterface.OnBtn1;
                    @Btn1.performed -= m_Wrapper.m_GameplayActionsCallbackInterface.OnBtn1;
                    @Btn1.canceled -= m_Wrapper.m_GameplayActionsCallbackInterface.OnBtn1;
                    @Btn2.started -= m_Wrapper.m_GameplayActionsCallbackInterface.OnBtn2;
                    @Btn2.performed -= m_Wrapper.m_GameplayActionsCallbackInterface.OnBtn2;
                    @Btn2.canceled -= m_Wrapper.m_GameplayActionsCallbackInterface.OnBtn2;
                    @Btn3.started -= m_Wrapper.m_GameplayActionsCallbackInterface.OnBtn3;
                    @Btn3.performed -= m_Wrapper.m_GameplayActionsCallbackInterface.OnBtn3;
                    @Btn3.canceled -= m_Wrapper.m_GameplayActionsCallbackInterface.OnBtn3;
